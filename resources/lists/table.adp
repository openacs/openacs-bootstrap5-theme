...
<table class="table table-striped table-auto" cellpadding="3" cellspacing="1"@list_properties.table_attributes;noquote@>
  <if "@list_properties.caption@" ne ""><caption>@list_properties.caption;noquote@</caption></if>
  <multiple name="elements">
    <thead>
      <tr class="list-header">
      <group column="subrownum">
        <th class="@elements.class@"@elements.cell_attributes;noquote@ id="@list_properties.name@_@elements.name@" nowrap>
